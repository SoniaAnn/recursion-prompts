...
var arraySum = function(array) {
  ...
  if(!Array.isArray(array[index])){
    ...
    result = array[index] + arraySum(array.slice(0, index));

    return result;
  }
  result = result + arraySum(array[index]) + arraySum(array.slice(0, index));
  return result;
};
...
var range = function(x, y) {
  ...
  if (start < end - 1) {
    ...
    result = (range(start, end-1)).concat(result);
  }
  if (start > end + 1) {
    result.unshift((end + 1));
    result = (range(start, (end + 1))).concat(result);
...
var divide = function(x, y) {
  ...
  if ((0 - x) - (0 - y) >= 0 && (y < 0 && x < 0)) {
    return 1 + divide((0 - x) - (0 - y), (0 - y));
  }
